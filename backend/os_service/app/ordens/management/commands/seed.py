...
DELEGACAO_SEDE_ID = uuid.UUID('10000000-0000-0000-0000-000000000001')
DELEGACAO_NORTE_ID = uuid.UUID('10000000-0000-0000-0000-000000000002')
...
SERVICO_ID = uuid.UUID('40000000-0000-0000-0000-000000000001')
SERVICO_DELEGACAO_ID = uuid.UUID('40000000-0000-0000-0000-000000000002')
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        os = OrdemServico.objects.create(
            ...
            delegacaoContratacaoId=DELEGACAO_SEDE_ID,
            delegacaoExecucaoId=DELEGACAO_SEDE_ID,
